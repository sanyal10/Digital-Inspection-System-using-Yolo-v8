...
results=model.predict(r'C:\Users\DEBAJYOTI\OneDrive\Desktop\project_finalyear\Building facade.v2i.yolov8\sample_images\sample_image_14.jpeg',save=False, imgsz=640, show_labels=False, conf=0.1,iou=0.5,show_conf=True)
...
print("Data type of image-coordinates",type(image_coordinates[0]),image_coordinates)
...
for i in range(len(img_box)):
    ...
    cv2.putText(original_image,str(dimns[i]),(c_x-10,c_y-10),cv2.FONT_HERSHEY_SIMPLEX,2,(255,255,0),5,cv2.LINE_AA) 
