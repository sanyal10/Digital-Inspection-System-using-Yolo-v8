...
results=model.predict(r'C:\Users\DEBAJYOTI\OneDrive\Desktop\project_finalyear\Building facade.v2i.yolov8\sample_images\sample_image_14.jpeg',save=False, imgsz=640, show_labels=False, conf=0.5,iou=0.5,show_conf=True)
